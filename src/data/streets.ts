...
export const streets: Street[] = [
  {
    ...
    designs: [
      ...
      { id: "b", name: "どんぐり", nameEn: "Acorn", emoji: "🌰", color: "#d97706" },
    ],
  ...
  },
  {
    ...
    color: "#7c3aed",
    designs: [
      { id: "a", name: "こうもり", nameEn: "Bat", emoji: "🦇", color: "#7c3aed" },
      { id: "b", name: "まじょ", nameEn: "Witch", emoji: "🧙", color: "#16a34a" },
    ],
  ...
  },
  {
    ...
    color: "#db2777",
    designs: [
      { id: "a", name: "キャンディ", nameEn: "Candy", emoji: "🍬", color: "#ec4899" },
      { id: "b", name: "おばけ", nameEn: "Ghost", emoji: "👻", color: "#475569" },
    ],
  ...
  },
  {
    ...
    color: "#f472b6",
    designs: [
      { id: "a", name: "カップケーキ", nameEn: "Cupcake", emoji: "🧁", color: "#f472b6" },
      { id: "b", name: "ロリポップ", nameEn: "Lollipop", emoji: "🍭", color: "#a855f7" },
    ],
  ...
  },
  {
    ...
    color: "#c026d3",
    designs: [
      { id: "a", name: "かめん", nameEn: "Mask", emoji: "🎭", color: "#c026d3" },
      { id: "b", name: "おつきさま", nameEn: "Moon", emoji: "🌙", color: "#4c1d95" },
    ],
